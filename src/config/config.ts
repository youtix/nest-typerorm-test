...
export class Config {
  ...
  'jhipster.mail.from' = 'lgo@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'lgo API';
  'jhipster.swagger.description' = 'lgo API documentation';
  ...
  'eureka.instance.appname' = 'lgo';
  'eureka.instance.instanceId' = 'lgo:${random.value}';
